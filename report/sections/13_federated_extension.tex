...
remain deferred until a useful sharing mechanism is established. Experiment 7C
(\cref{sec:experiment7c}) then tests the stronger complementary-coverage premise:
each client observes only one speed, while its oracle family jointly spans the
complete envelope. An equal-transition full-envelope LocalExtra oracle separates
the value of shared information from the value of additional local experiments.
