...
The five oracle architectures are defined in \cref{tab:methods}. M1--M4 form a
two-factor comparison between scheduling and structural specialization, while M5
tests whether a larger bank of frozen LTI prototypes can substitute for continuous
scheduling.
\begin{table}[ht]
\centering
